...
/// </list>
/// 讀寫失敗退預設／靜默降級，不致命。（Issue #55 之全域 ColorRules 已於 #69 改為情境內各色描述，見 <see cref="LingoIsland.Query.ContextItem.ColorRules"/>。）
/// </summary>
public static class NoteDefaults
{
    ...
    // ColorRules 欄位仍保留於 DTO 以相容舊 note-defaults.json（讀時忽略；#69 起配色規則改存於情境）
