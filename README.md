...
| 開啟主視窗 | 點工作列 ScreenTrans 按鈕／`Alt+Tab`，或系統匣圖示 → 開啟**統一主視窗**（上方分頁：筆記／歷史／選項／關於） |
